 Program osborne2
    ...
    Open(Unit = 98, File = trim(pwd)//"/../output/solution_andreani_scaled100.txt", ACCESS = "SEQUENTIAL")
    write(98,"(11F7.3)") xk(1),xk(2),xk(3),xk(4)

    Open(Unit = 99, File = trim(pwd)//"/../output/outliers_andreani_scaled100.txt", ACCESS = "SEQUENTIAL")
